        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (id!=null && action!=null){
                if (action.equals("Approve")){
                    ...
                    StatusDAO sttDao=new StatusDAO();
                    sttDao.rejectRequest(id);
                }
            }
            
            String idSelected= (String) request.getParameter("idSelected");
            if (idSelected==null){
                idSelected="";
            }
            
            EmployeeDAO empdao=new EmployeeDAO();
            List<Employee> listByName=empdao.selectAll();
            
            RequestDAO resdao=new RequestDAO();
            List<RequestMerge> listByID=new ArrayList<>();
            if (idSelected.equals("")){
                listByID=resdao.selectAll();
            }
            else listByID=resdao.selectByID(idSelected);
