 ...
 * @author tuans
 */
public class MyPrint extends BodyTagSupport {
    ...
    public int doAfterBody() throws JspException {
        try {
            ...
            //get body context of tag
            String content=bodyCont.getString();
            out.println(content);//output the content
            bodyCont.clear();//clear the buffer of body content
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in MyPrint tag", ex);
    }
