 ...
 * @author tuans
 */
public class LoadBeforeAssignServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<String> listByName=dao.selectAllName();
            ...
            Logger.getLogger(LoadBeforeAssignServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
